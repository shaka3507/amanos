...
export function LocationPermissionModal({ onLocationSet, onClose }: LocationPermissionModalProps) {
  ...
  // Add a slight delay before showing the modal for a smooth animation
  useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center">
      ...
      <div 
        className={cn(
          "relative w-full max-w-md rounded-t-2xl sm:rounded-2xl bg-white p-6 shadow-lg transition-all duration-300 transform",
